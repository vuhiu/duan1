                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <a href="?act=sanpham&page=xoa&id=<?= $product['product_id'] ?>"
                                class="btn btn-danger btn-sm"
                                onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này? Lưu ý: Chỉ có thể xóa sản phẩm chưa có trong đơn hàng.')">Xóa</a>
                        </div>
                    </td>
                </tr>
            <?php endforeach; ?>
