                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <?php if ($order['status'] == 'pending') : ?>
                            <a href="index.php?act=order&page=confirm&id=<?= htmlspecialchars($order['order_detail_id']) ?>"
                                class="btn btn-info">
                        ...
                        <?php if ($order['status'] != 'cancelled' && $order['status'] != 'delivered') : ?>
                            <a href="index.php?act=order&page=cancel&id=<?= htmlspecialchars($order['order_detail_id']) ?>"
